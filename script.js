...
let count = Number(window.localStorage.getItem("count"));  // because it will be string and we have to explicitly convert it into number 
if (!count){
...
function createNoteFromInput(e){
    ...
    document.getElementById("new-note-body-input").value=""; // after submitting we dont want our form to have anything  we want it to be empty thats why
